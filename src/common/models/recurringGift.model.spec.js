...
describe('recurringGift model', () => {
  ...
  describe('constructor', () => {
    beforeEach(() => {
      jest.spyOn(RecurringGiftModel.prototype, 'initializeEmptyFields').mockImplementation(() => {})
    })
  ...
  describe('setDefaults', () => {
    it('should set default values for a new gift', () => {
      expect(giftModel.setDefaults().toObject).toEqual(expect.objectContaining({
  ...
  describe('setDefaultsSingleGift', () => {
    it('should set default values for a new single gift', () => {
      expect(giftModel.setDefaultsSingleGift().toObject).toEqual(expect.objectContaining({
        'updated-designation-number': giftModel.gift['designation-number']
      }))
    })
  })
