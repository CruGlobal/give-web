...
describe('desigSrc', function () {
  ...
  let img; let scope; const desigNum = '0561484'; const campaignPage = '9876'

  describe('without campaignPage', () => {
    beforeEach(inject(function (_$compile_, _$rootScope_) {
      const tpl = '<img desig-src="' + desigNum + '" class="giftsum-profile pull-left">'
  ...
  describe('with campaignPage', () => {
    beforeEach(inject(function (_$compile_, _$rootScope_) {
      const tpl = '<img desig-src="' + desigNum + '" campaign-page="' + campaignPage + '" class="giftsum-profile pull-left">'
      scope = _$rootScope_.$new()
      img = _$compile_(tpl)(scope)
      scope.$digest()
    }))
