...
describe('paymentMethodSort', () => {
  ...
  describe('sortPaymentMethods', () => {
    ...
    it('should put credit cards expiring farther in the future before those expiring sooner', () => {
      ...
      expect(sortPaymentMethods([creditCard2, creditCard1, creditCard3])).toEqual([creditCard2, creditCard1, creditCard3]);
      expect(sortPaymentMethods([creditCard2, creditCard3, creditCard1])).toEqual([creditCard2, creditCard1, creditCard3]);
    ...
    it('should sort all payment methods into the correct order', () => {
      ...
      // Reverse
      expect(sortPaymentMethods([creditCard3, creditCard1, creditCard2, savingsAccount1, savingsAccount2, checkingAccount1, checkingAccount2])).toEqual([checkingAccount1, checkingAccount2, savingsAccount1, savingsAccount2, creditCard2, creditCard1, creditCard3]);
      // Random
