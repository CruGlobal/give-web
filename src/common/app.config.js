...
const appConfig = /* @ngInject */ function (envServiceProvider, $compileProvider, $logProvider, $httpProvider, $locationProvider, $qProvider, $translateProvider) {
  ...
  $translateProvider.translations('en', {
    ...
    MESSAGE_EXAMPLE: 'For example: stop my gift after 18 months, make this gift anonymous (note: remove any messages to ministry or missionary to remain anonymous), etc.',
