...
export const appConfig = /* @ngInject */ function (envServiceProvider, $compileProvider, $logProvider, $httpProvider, $locationProvider, $qProvider, $translateProvider) {
  ...
  $translateProvider.translations('en', {
    ...
    I_AGREE: 'I acknowledge that I have read, understand, and agree to the <a id="agreementLink" ng-click="$ctrl.toggleAgreement($event)">terms and conditions</a> regarding electronic fund transfer.',
    ...
    REVIEW_EMAIL_ERROR: 'There was an issue with your email. Please verify that it is correct.',
    REVIEW_PAYMENT_ERROR: 'There was an issue with your payment. Please verify that all your payment information is correct.',
    REVIEW_BILLING_ADDRESS_ERROR: 'There was an issue with your billing address. Please verify that your billing address is correct.',
    ...
    REVIEW_SUBMITTING_PAYMENT_ERROR: 'There was an error submitting your payment. Verify that your payment info is correct or try adding it again. If you are still seeing this message, please contact <a href="mailto:eGift@cru.org">eGift@cru.org</a> for assistance.',
    ...
    REVIEW_INSUFFICIENT_FUNDS_ERROR: 'Your credit card was declined due to insufficient funds.',
    REVIEW_EXCEEDS_BALANCE_ERROR: 'This transaction exceeds your available card balance.',
    REVIEW_INVALID_SEC_CODE_ERROR: 'The security code entered for your card is invalid.',
    REVIEW_ADDRESS_MISMATCH_ERROR: 'The billing address entered does not match the address associated with the card.',
    ...
    AMOUNT: 'Amount',
    WARNING: 'Warning!',
    FUTURE_WARNING: 'You are about to give a gift starting {{days}} days in the future.',
    ...
    RETRY_LOAD: 'There was an error loading your gifts. You may <a id="retryLoadButton" href="" ng-click="{{retryLoadFunction}}">retry</a> loading them. If you continue to see this message, please contact <a href="mailto:eGift@cru.org">eGift@cru.org</a> for assistance.',
  ...
  $translateProvider.translations('es', {
    ...
    BANK_AGREEMENT_MESSAGE: 'By selecting the "I Agree" checkbox below, I acknowledge that I have read, understand and agree to these Terms and Conditions, and that this agreement constitutes a "writing signed by me" under any applicable law or regulation. I authorize Cru to initiate electronic funds transfers (debits) from my account at the financial institution listed above, and to initiate deposits (credits) if necessary for any withdrawals made in error. This authority is to remain in full force and effect until Cru has received notification from me of its termination in such time as to afford Cru reasonable opportunity to act on it. All contributions to Cru are income tax-deductible and are made with the understanding that Cru has complete discretion and control over the use of all donated funds.',
    I_AGREE: 'Reconozco que he leído, comprendido y acepto los <a id="agreementLink" ng-click="$ctrl.toggleAgreement($event)">términos y condiciones</a> relacionados con la transferencia electrónica de fondos.',
