...
describe('Designation Editor', function () {
  ...
  describe('$onInit', () => {
    beforeEach(() => {
      ...
      jest
        ...
        .mockReturnValue({ d: designationSecurityResponse.designationNumber });
    });

    it('get designationNumber', () => {
      $ctrl.$onInit();

      expect($ctrl.designationNumber).toEqual(
        designationSecurityResponse.designationNumber,
      );
    });
  ...
  describe('getDesignationContent()', () => {
    ...
    it('should sign in and try again if the response is 422', (done) => {
      ...
      jest
        .spyOn($ctrl.sessionModalService, 'open')
        .mockReturnValue({ result: signInDeferred.promise });
    ...
    it('should only retry once if the response is repeatedly 422', (done) => {
      ...
      jest
        .spyOn($ctrl.sessionModalService, 'open')
        .mockReturnValue({ result: $q.resolve() });
    ...
    it('should log an error if content fails', () => {
      ...
      jest
        .spyOn($ctrl.designationEditorService, 'getContent')
        .mockImplementation(() => {
          const p = $q.defer();
          p.reject('some error');
          return p.promise;
  ...
  describe('modals', () => {
    beforeEach(() => {
      ...
      jest
        .spyOn($ctrl, 'save')
        .mockReturnValue({ result: savePromise.promise });
    });
    ...
    describe('title modal', () => {
      ...
      it('should open modal', () => {
        ...
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.receiptTitle(),
        ).toEqual(designationSecurityResponse.designationName);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.giveTitle(),
        ).toEqual(designationSecurityResponse['jcr:title']);
    ...
    describe('page options modal', () => {
      ...
      it('should open modal', () => {
        ...
        expect($ctrl.$uibModal.open).toHaveBeenCalled();
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.parentDesignationNumber(),
        ).toEqual(designationSecurityResponse.parentDesignationNumber);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.organizationId(),
        ).toEqual(designationSecurityResponse.organizationId);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.facebookPixelId(),
        ).toEqual(designationSecurityResponse.facebookPixelId);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.suggestedAmounts(),
        ).toEqual(designationSecurityResponse.suggestedAmounts);
        ...
        expect($ctrl.designationContent.parentDesignationNumber).toEqual(
          '000777',
        );
    ...
    describe('personal options modal', () => {
      ...
      beforeEach(inject((_$q_) => {
        ...
        jest
          ...
          .mockReturnValue({ result: modalPromise.promise });
        jest
          .spyOn($ctrl.designationEditorService, 'hasNewsletter')
      ...
      it('should open modal', async () => {
        ...
        ).toEqual(designationSecurityResponse.designationNumber);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.giveDomain(),
        ).toEqual($ctrl.giveDomain);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.designationType(),
        ).toEqual(designationSecurityResponse.designationType);
        await expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.hasNewsletter,
        ).resolves.toBe(true);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.givingLinks(),
        ).toEqual(designationSecurityResponse.givingLinks);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.showNewsletterForm(),
        ).toEqual(designationSecurityResponse.showNewsletterForm);
    ...
    describe('photo modal', () => {
      ...
      it('should open modal', () => {
        ...
        $ctrl.selectPhoto(
          photoLocation,
          designationSecurityResponse.coverPhoto,
        );
        ...
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.campaignPage(),
        ).toBeUndefined();
        expect($ctrl.$uibModal.open.mock.calls[0][0].resolve.photos()).toEqual(
          photos,
        );
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.photoLocation(),
        ).toEqual(photoLocation);
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.selectedPhoto(),
        ).toEqual(designationSecurityResponse.coverPhoto);
    ...
    describe('carousel modal', () => {
      ...
      it('should open modal', () => {
        ...
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.photoLocation(),
        ).toEqual('secondaryPhotos');
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.selectedPhoto(),
        ).toEqual(selectedPhotos);
      });

      it('should have empty selectedPhotos', () => {
        $ctrl.selectPhotos(
          'secondaryPhotos',
          designationSecurityResponse['design-controller'].carousel,
        );
        modalPromise.resolve({
          selected: '',
          photos: [],
    ...
    describe('edit text modal', () => {
      ...
      it('should open modal', () => {
        ...
        expect($ctrl.$uibModal.open).toHaveBeenCalled();
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.initialText(),
        ).toEqual(designationSecurityResponse.paragraphText);
    ...
    describe('edit website modal', () => {
      ...
      it('should open modal', () => {
        ...
        expect($ctrl.$uibModal.open).toHaveBeenCalled();
        expect(
          $ctrl.$uibModal.open.mock.calls[0][0].resolve.initialWebsite(),
        ).toEqual(designationSecurityResponse.websiteURL);

        modalPromise.resolve('http://www.cru.org/website');
        $rootScope.$digest();

        expect($ctrl.designationContent.websiteURL).toEqual(
          'http://www.cru.org/website',
        );
      });
    });
  });
      ...
      const photos = [
        {
          ...
          cover:
            '/content/dam/give/designations/0/5/CMS1_064561.jpg.transform/GiveDesignationCoverPhoto/img.jpg',
          thumbnail:
            '/content/dam/give/designations/826/CMS1_064561.jpg.transform/GiveDesignationThumbnail/img.jpg',
          secondary:
            '/content/dam/give/designations/826/CMS1_064561.jpg.transform/GiveDesignationSmallerPhoto/img.jpg',
        },
        {
          original: '/content/dam/give/designations/026/CMS1_063495.jpg',
          cover:
            '/content/dam/give/designations/0/5/CMS1_063495.jpg.transform/GiveDesignationCoverPhoto/img.jpg',
          thumbnail:
            '/content/dam/give/designations/826/CMS1_063495.jpg.transform/GiveDesignationThumbnail/img.jpg',
          secondary:
            '/content/dam/give/designations/826/CMS1_063495.jpg.transform/GiveDesignationSmallerPhoto/img.jpg',
        },
        {
          original: '/content/dam/give/designations/026/CMS1_010.jpg',
          cover:
            '/content/dam/give/designations/0/5/CMS1_086010.jpg.transform/GiveDesignationCoverPhoto/img.jpg',
          thumbnail:
            '/content/dam/give/designations/826/CMS1_08010.jpg.transform/GiveDesignationThumbnail/img.jpg',
          secondary:
            '/content/dam/give/designations/826/CMS1_080.jpg.transform/GiveDesignationSmallerPhoto/img.jpg',
        },
        {
          original: '/content/dam/give/designations/026/CMS1_055.jpg',
          cover:
            '/content/dam/give/designations/0/5/CMS1_0535.jpg.transform/GiveDesignationCoverPhoto/img.jpg',
          thumbnail:
            '/content/dam/give/designations/826/CMS1_035.jpg.transform/GiveDesignationThumbnail/img.jpg',
          secondary:
            '/content/dam/give/designations/826/CMS1_035.jpg.transform/GiveDesignationSmallerPhoto/img.jpg',
        },
      ];
      $ctrl.designationPhotos = photos;
  ...
  describe('save', () => {
    it('should save designation content', (done) => {
      jest
        ...
        .mockImplementation((role, callbacks) => {
          const signInAsync = () => {
      ...
      $ctrl.designationContent = designationSecurityResponse;
      jest
        .spyOn($ctrl.designationEditorService, 'save')
  ...
  describe('getImageUrls', () => {
    it('should return just the URLs of the images in the carousel', () => {
      ...
      const imageUrls = $ctrl.getImageUrls(
        designationSecurityResponse['design-controller'].carousel,
      );
  ...
  describe('getDoneEditingUrl()', () => {
    ...
    it('should return the first vanity url', () => {
      $ctrl.designationContent = designationSecurityResponse;
      $ctrl.designationContent['sling:vanityPath'] = [
        `/content/give/us/en/${designationNumber}`,
      ];
      expect($ctrl.getDoneEditingUrl()).toEqual(
        `/${designationNumber}${cacheBust}`,
      );
    });
