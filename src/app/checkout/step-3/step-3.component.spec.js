  ...
  describe('step 3', () => {
    ...
    describe('updateGiftStartMonth', () => {
      it('should save item edits', () => {
        ...
        expect(self.controller.cartService.editItem).toHaveBeenCalledWith(
          item.uri,
          item.productUri,
          item.config,
        );
    ...
    describe('loadCurrentPayment', () => {
      it('should load bank account payment details', () => {
        ...
        expect(self.controller.bankAccountPaymentDetails).toEqual(
          self.loadedPayment,
        );
      ...
      it('should load credit card payment details', () => {
        ...
        expect(self.controller.creditCardPaymentDetails).toEqual(
          self.loadedPayment,
        );
        self.controller.$log.assertEmpty();
      ...
      it('should log an error on failure', () => {
        jest
          .spyOn(self.controller.orderService, 'getCurrentPayment')
          .mockReturnValue(Observable.throw('some error'));
        self.controller.loadCurrentPayment();

        expect(self.controller.$log.error.logs[0]).toEqual([
          'Error loading current payment info',
          'some error',
        ]);
        expect(self.controller.loadingCurrentPayment).toEqual(false);
      });
    ...
    describe('checkErrors', () => {
      ...
      it('should log and error on failure', () => {
        jest
          .spyOn(self.controller.orderService, 'checkErrors')
          .mockReturnValue(Observable.throw('some error'));
        self.controller.checkErrors();

        expect(self.controller.$log.error.logs[0]).toEqual([
          'Error loading checkErrors',
          'some error',
        ]);
      });
    });
    ...
    describe('canSubmitOrder', () => {
      function runCanSubmitOrder(config) {
        ...
        self.controller.bankAccountPaymentDetails =
          config.bankAccountPaymentDetails;
        self.controller.creditCardPaymentDetails =
          config.creditCardPaymentDetails;
    ...
    describe('submitOrder', () => {
      ...
      it('should call analyticsFactory when it is not branded checkout', () => {
        ...
        expect(self.controller.analyticsFactory.purchase).toHaveBeenCalledWith(
          self.controller.donorDetails,
          self.controller.cartData,
          self.controller.orderService.retrieveCoverFeeDecision(),
        );
      ...
      it('should not call analyticsFactory when it is branded checkout', () => {
        ...
        expect(
          self.controller.analyticsFactory.purchase,
    ...
    describe('logToDatadogRum', () => {
      ...
      it('should log a checkout error', () => {
        ...
        expect(self.controller.datadogRum.addError).toHaveBeenCalledWith(
