...
describe('Checkout Help', function() {
  ...
  it('get help block content from AEM', function() {
    $httpBackend.expectGET('/designations/jcr%3Acontent/need-help-ipar/contentfragment.html')
  ...
  it('should log an error on failure', () => {
    $httpBackend.expectGET('/designations/jcr%3Acontent/need-help-ipar/contentfragment.html').respond(500, 'some error');
    $ctrl.$onInit();
    $httpBackend.flush();
