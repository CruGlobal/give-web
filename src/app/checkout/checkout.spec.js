...
describe('checkout', function () {
  ...
  describe('$onInit()', () => {
    beforeEach(() => {
      ...
      jest
        .spyOn(self.controller.checkoutService, 'initializeRecaptcha')
        .mockImplementation(() => {});
    ...
    it('initializes the component', () => {
      ...
      expect(
        self.controller.checkoutService.initializeRecaptcha,
      ).toHaveBeenCalled();
    });
  ...
  describe('$onDestroy()', () => {
    it('cleans up the component', () => {
      ...
      expect(
        self.controller.sessionEnforcerService.cancel,
  ...
  describe('listenForLocationChange', () => {
    it('should watch the url and update the state', () => {
      jest.spyOn(self.controller, 'initStepParam').mockImplementation(() => {});
      jest
        .spyOn(self.controller.cartService, 'get')
        .mockReturnValue(Observable.of('cartData'));
      jest
        .spyOn(self.controller.analyticsFactory, 'checkoutStepEvent')
        .mockImplementation(() => {});
      ...
      expect(
        self.controller.analyticsFactory.checkoutStepEvent,
      ).toHaveBeenCalledWith('review', 'cartData');
    });
  });
  ...
  describe('changeStep', () => {
    it('should scroll to top and change the checkout step', () => {
      ...
      expect(self.controller.$location.search).toHaveBeenCalledWith(
        'step',
        'review',
      );
    ...
    it('should retain query parameters on thank you page', () => {
      ...
      mockSearch(searchObject);
      self.controller.changeStep('thankYou');
      expect(self.controller.$window.location.href).toEqual(
        '/thank-you.html?one=1&two=2',
      );
    });
