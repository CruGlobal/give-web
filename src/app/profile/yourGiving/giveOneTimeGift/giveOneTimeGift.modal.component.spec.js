...
describe('giveOneTimeGiftModal', () => {
  ...
  describe('$onInit', () => {
    it('should call loadRecentRecipients', () => {
      jest.spyOn(self.controller, 'loadRecentRecipients').mockImplementation(() => {})
  ...
  describe('loadRecentRecipients', () => {
    ...
    it('should load recent recipients', () => {
      jest.spyOn(self.controller.donationsService, 'getRecentRecipients').mockReturnValue(Observable.of([{ 'designation-name': 'Staff Member', 'designation-number': '0123456' }]))
    ...
    it('should handle an error loading recent recipients', () => {
      jest.spyOn(self.controller.donationsService, 'getRecentRecipients').mockReturnValue(Observable.throw('some error'))
      self.controller.loadRecentRecipients()
  ...
  describe('next', () => {
    ...
    it('should transition from step2EnterAmounts, add gifts to cart, close the modal, and open the mini nav cart', () => {
      jest.spyOn(self.controller, 'addSelectedRecipientsToCart').mockImplementation(() => {})
  ...
  describe('addSelectedRecipientsToCart', () => {
    beforeEach(() => {
      jest.spyOn(self.controller.cartService, 'bulkAdd').mockImplementation(() => {})
    ...
    it('should add the selected recipients to cart, close the modal, and open the mini cart', () => {
      self.controller.cartService.bulkAdd.mockReturnValue(Observable.from([{ configuredDesignation: { designationNumber: '0123456', amount: 57, uri: 'uri1' } }]))
    ...
    it('should show the recipients that failed to be added to cart to the user', () => {
      self.controller.cartService.bulkAdd.mockReturnValue(Observable.from([
    ...
    it('should handle a generic error that is not gift specific', () => {
      self.controller.cartService.bulkAdd.mockReturnValue(Observable.throw('some error'))
      self.controller.selectedRecipients = [
        { designationNumber: '0123456', amount: 57 }
      ]
      self.controller.addSelectedRecipientsToCart()
