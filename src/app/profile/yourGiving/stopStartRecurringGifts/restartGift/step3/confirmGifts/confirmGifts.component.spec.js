        ...
        describe( 'confirmGifts', () => {
          ...
          describe( 'processRestarts()', () => {
            ...
            describe( 'has additions', () => {
              beforeEach( () => {
                $ctrl.adds = [new RecurringGiftModel( {'designation-name': 'Batman'} )];
                $ctrl.saved = [];
              } );
            ...
            describe( 'has updates', () => {
              beforeEach( () => {
                $ctrl.updates = [new RecurringGiftModel( {'designation-name': 'Batman'} )];
                $ctrl.saved = [];
              } );
            ...
            describe( 'has updates and additions', () => {
              beforeEach( () => {
                $ctrl.adds = [new RecurringGiftModel( {'designation-name': 'Batman'} )];
                $ctrl.updates = [new RecurringGiftModel( {'designation-name': 'Charles Xavier'} )];
                $ctrl.saved = [];
              } );
