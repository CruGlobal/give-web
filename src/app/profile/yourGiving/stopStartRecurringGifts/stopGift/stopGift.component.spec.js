    ...
    describe('stopGift', () => {
      ...
      describe('loadRecurringGifts()', () => {
        it('loads recurring gifts and changes step', () => {
          jest.spyOn($ctrl.donationsService, 'getRecurringGifts').mockReturnValue(Observable.of(['a', 'b']))
        ...
        it('should log an error on failure', () => {
          jest.spyOn($ctrl.donationsService, 'getRecurringGifts').mockReturnValue(Observable.throw('some error'))
          $ctrl.loadRecurringGifts()
