  ...
  describe('step 1 editRecurringGifts', () => {
    ...
    describe('loadGifts', () => {
      it('should load gifts', () => {
        jest.spyOn(self.controller.donationsService, 'getRecurringGifts').mockReturnValue(Observable.of('gifts response'))
      ...
      it('should handle an error loading gifts', () => {
        jest.spyOn(self.controller.donationsService, 'getRecurringGifts').mockReturnValue(Observable.throw('gifts error'))
        self.controller.loadGifts()
