  ...
  describe('step 4 confirmRecurringGifts', () => {
    ...
    describe('saveChanges', () => {
      it('should update gifts', () => {
        ...
        jest.spyOn(self.controller.donationsService, 'updateRecurringGifts').mockImplementation(gifts => {
          updatedGifts = clone(gifts)
          return Observable.of('update gifts response')
        })
        jest.spyOn(self.controller.donationsService, 'addRecurringGifts').mockImplementation(gifts => {
        ...
        expect(self.controller.donationsService.addRecurringGifts).toHaveBeenCalledWith(expect.anything())
      ...
      it('should handle an error updating recurring gifts', () => {
        ...
        jest.spyOn(self.controller.donationsService, 'updateRecurringGifts').mockReturnValue(Observable.throw({ data: 'update gifts error' }))
        jest.spyOn(self.controller.donationsService, 'addRecurringGifts').mockReturnValue(Observable.of('add gifts response'))
        self.controller.saveChanges()
      ...
      it('should handle an unknown error adding gifts', () => {
        ...
        jest.spyOn(self.controller.donationsService, 'updateRecurringGifts').mockReturnValue(Observable.of('update gifts response'))
        jest.spyOn(self.controller.donationsService, 'addRecurringGifts').mockReturnValue(Observable.throw({}))
        self.controller.saveChanges()
