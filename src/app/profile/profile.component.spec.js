...
describe('ProfileComponent', function () {
  ...
  describe('loadDonorDetails()', () => {
    ...
    it('should load donor details on $onInit() and have a spouse info', () => {
      ...
      jest
        .spyOn($ctrl.profileService, 'getProfileDonorDetails')
  ...
  describe('loadMailingAddress()', () => {
    it('should load mailing address on $onInit()', () => {
      ...
      jest
        .spyOn($ctrl.profileService, 'getMailingAddress')
        .mockReturnValue(Observable.of(data));
    ...
    it('should handle and error of loading mailing address on $onInit()', () => {
      jest.spyOn($ctrl.profileService, 'getMailingAddress').mockReturnValue(
        Observable.throw({
          data: 'some error',
        }),
      );
  ...
  describe('loadEmail()', () => {
    it('should load email on $onInit()', () => {
      ...
      jest
        .spyOn($ctrl.profileService, 'getEmails')
        .mockReturnValue(Observable.of(data));
      $ctrl.loadEmail();
    ...
    it('should handle and error of loading email on $onInit()', () => {
      jest.spyOn($ctrl.profileService, 'getEmails').mockReturnValue(
        Observable.throw({
          data: 'some error',
        }),
      );
  ...
  describe('updateEmail()', () => {
    ...
    it('should update donor email', () => {
      jest
        .spyOn($ctrl.profileService, 'updateEmail')
        .mockReturnValue(Observable.of({ email: 'new email' }));
    ...
    it('should handle and error of updating email', () => {
      jest.spyOn($ctrl.profileService, 'updateEmail').mockReturnValue(
        Observable.throw({
          data: 'some error',
        }),
      );
  ...
  describe('syncPhoneValidators()', () => {
    it('should add phone number validators to inputs', () => {
      ...
      expect(
        $ctrl.phoneNumberForms[0].phoneNumber.$validators.phone('541-967-0010'),
      ).toEqual(true);
      expect(
        $ctrl.phoneNumberForms[0].phoneNumber.$validators.phone('123-abc-7890'),
      ).toEqual(false);
    });
  });
  ...
  describe('loadPhoneNumbers()', () => {
    it('should load phone numbers on $onInit()', () => {
      jest
        .spyOn($ctrl.profileService, 'getPhoneNumbers')
        .mockReturnValue(Observable.of([{}]));
    ...
    it('should handle and error of loading phone numbers on $onInit()', () => {
      jest.spyOn($ctrl.profileService, 'getPhoneNumbers').mockReturnValue(
        Observable.throw({
          data: 'some error',
        }),
      );
    ...
    it('should properly handle cache', () => {
      ...
      jest
        .spyOn($ctrl.profileService, 'getPhoneNumbers')
        .mockReturnValue(Observable.of([onlyPhoneNumber]));
  ...
  describe('updatePhoneNumbers()', () => {
    ...
    it('should update phone number', () => {
      ...
      jest
        .spyOn($ctrl.profileService, 'updatePhoneNumber')
        .mockReturnValue(Observable.of('data'));
    ...
    it('should fail updating phone number', () => {
      ...
      jest.spyOn($ctrl.profileService, 'updatePhoneNumber').mockReturnValue(
        Observable.throw({
          data: 'some error',
        }),
      );
    ...
    it('should delete phone number', () => {
      ...
      jest
        .spyOn($ctrl.profileService, 'deletePhoneNumber')
        .mockReturnValue(Observable.of('data'));
      jest.spyOn($ctrl, 'resetPhoneNumberForms').mockImplementation(() => {});
      $ctrl.updatePhoneNumbers();
    ...
    it('should fail deleting phone number', () => {
      ...
      jest.spyOn($ctrl.profileService, 'deletePhoneNumber').mockReturnValue(
        Observable.throw({
          data: 'some error',
        }),
      );
    ...
    it('should add phone number', () => {
      ...
      jest
        .spyOn($ctrl.profileService, 'addPhoneNumber')
        .mockImplementation((phoneNumbers) => {
    ...
    it('should display the message from an object payload on a 4xx error', () => {
      ...
      jest.spyOn($ctrl.profileService, 'addPhoneNumber').mockReturnValue(
        Observable.throw({
          status: 422,
          data: { message: 'Phone number is not a valid US number.' },
        }),
      );
      $ctrl.updatePhoneNumbers();
    ...
    it('should keep the generic message when a 4xx body has no message', () => {
      $ctrl.phoneNumbers = [
        {
          self: false,
          delete: false,
    ...
    it('should subscribe once for multiple phone numbers', () => {
      $ctrl.phoneNumbers = [
        {
          self: false,
          delete: false,
      ...
      jest
        .spyOn($ctrl.profileService, 'addPhoneNumber')
        .mockReturnValue(Observable.of({ self: '<new link>' }));
      jest.spyOn($ctrl, 'resetPhoneNumberForms').mockImplementation(() => {});
      $ctrl.updatePhoneNumbers();

      // Before hoisting forkJoin out of the loop this fired once per phone.
      expect($ctrl.profileService.addPhoneNumber).toHaveBeenCalledTimes(2);
      expect($ctrl.resetPhoneNumberForms).toHaveBeenCalledTimes(1);
    });
  });
  ...
  describe('deletePhoneNumber()', () => {
    it('should delete phone number from a local list', () => {
      ...
      expect(
        $ctrl.phoneNumberForms[0].phoneNumber.$setValidity,
      ).toHaveBeenCalled();
  ...
  describe('updateMailingAddress()', () => {
    ...
    it('should update mailing address', () => {
      jest
        .spyOn($ctrl.profileService, 'updateMailingAddress')
        .mockReturnValue(Observable.of('data'));
    ...
    it('should fail updating mailing address', () => {
      jest.spyOn($ctrl.profileService, 'updateMailingAddress').mockReturnValue(
        Observable.throw({
          data: 'some error',
        }),
      );
  ...
  describe('saveSpouse()', () => {
    ...
    it('should save spouse info', () => {
      ...
      jest
        .spyOn($ctrl.profileService, 'addSpouse')
        .mockReturnValue(Observable.of('data'));
      $ctrl.saveSpouse();

      expect($ctrl.profileService.addSpouse).toHaveBeenCalledWith(
        '/donordetails/crugive/spousedetails',
        $ctrl.donorDetails['spouse-name'],
      );
    ...
    it('should handle fail of saving spouse info', () => {
      jest.spyOn($ctrl.profileService, 'addSpouse').mockReturnValue(
        Observable.throw({
          data: 'some error',
        }),
      );
