...
describe('PaymentMethodsComponent', function () {
  ...
  describe('loadPaymentMethods()', () => {
    it('should load payment methods on $onInit()', () => {
      ...
      expect(
        $ctrl.profileService.getPaymentMethodsWithDonations,
      ).toHaveBeenCalled();
    });
  ...
  describe('loadDonorDetails()', () => {
    it('should get donor details', () => {
      jest
        ...
        .mockReturnValue(Observable.of({ mailingAddress: 'address' }));
    ...
    it('should log an error', () => {
      ...
      expect($ctrl.$log.error.logs[0]).toEqual([
        'Error loading mailing address for use in profile payment method add payment method modals',
        'some error',
      ]);
    });
  });
  ...
  describe('addPaymentMethod()', () => {
    it('should open addPaymentMethod Modal', () => {
      ...
      jest
        ...
        .mockImplementation(() => {});
      $ctrl.$uibModal.open.mock.calls[0][0].resolve.onPaymentFormStateChange()({
        $event: {},
      });
  ...
  describe('onPaymentFormStateChange()', () => {
    ...
    it('should handle data.address format', () => {
      ...
      expect($ctrl.paymentMethodFormModal.close).toHaveBeenCalledWith(
        expectedData,
      );
    });
